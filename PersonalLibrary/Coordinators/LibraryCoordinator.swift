...
class LibraryCoordinator: NSObject {
    ...
    fileprivate func configureNavigation() {
        ...
        //Navigation
        booksViewController.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add,
                                                                                target: self,
                                                                                action: #selector(LibraryCoordinator.addBook))
        ...
        //Navigation
        authorViewController.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add,
                                                                                 target: self,
                                                                                 action: #selector(LibraryCoordinator.addAuthor))
        ...
        //Navigation
        signInViewController.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Close",
                                                                                style: .plain,
                                                                                target: self,
                                                                                action: #selector(LibraryCoordinator.closeAccountManipulation))
